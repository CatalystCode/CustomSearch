...
The need to navigate specific content areas via question and answers is a common
...
Consumer search engines combine many sophisticated techniques to provide the best
results.  From augmenting and indexing target content to augmenting search queries, to retrieval ranking and
performance measurement, consumer search engines employ several processes to
deliver the best results.   Indexing and augmenting content involves natural language processing (NLP) techniques
...
Despite the promise of AI and expert systems, designing a custom search experience for
...
We worked with one of the global ‘Big Four’ professional services firms
...
In this project, we describe how we addressed the challenge of creating
